import{a as E}from"./chunk-GW7PPLHE.js";import{f as P,g as O,h as k,m as S}from"./chunk-M4FQTJRQ.js";import{Da as l,Fa as x,Ka as o,La as t,Ma as g,Na as j,Oa as h,Pa as _,Qa as C,Ra as M,Sa as z,Ta as d,Ua as y,V as u,Va as w,W as c,da as p,la as v,ma as b,na as i,ra as f,va as q,ya as m}from"./chunk-7UNYG63N.js";var I=["starsCanvas"];function R(n,e){if(n&1&&(o(0,"a",17),d(1," \u{1F4F7} Ver imagen "),t()),n&2){let a=e.$implicit;l("href",a,b)}}function F(n,e){if(n&1&&(o(0,"div",15),m(1,R,2,1,"a",16),t()),n&2){let a=_().$implicit;i(),l("ngForOf",a.imagenes)}}function D(n,e){if(n&1){let a=j();o(0,"div",7),h("click",function(){let r=u(a).$implicit;return c(r.abierto=!r.abierto)}),o(1,"div",8)(2,"span",9),d(3),t(),o(4,"span",10),d(5),t(),o(6,"span",11),d(7),t()(),o(8,"div",12)(9,"p",13),h("click",function(r){return u(a),c(r.stopPropagation())}),t(),m(10,F,2,1,"div",14),t()()}if(n&2){let a=e.$implicit;i(3),y(a.fecha),i(2),y(a.titulo),i(2),w(" ",a.abierto?"\u2212":"+"," "),i(),x("abierto",a.abierto),i(),l("innerHTML",a.texto,v),i(),l("ngIf",a.imagenes==null?null:a.imagenes.length)}}var H=class n{constructor(e){this.http=e}canvasRef;ctx;stars=[];animationId;width=window.innerWidth;height=window.innerHeight;ngAfterViewInit(){this.initCanvas(),this.createStars(120),this.animate(),window.addEventListener("resize",this.onResize)}ngOnDestroy(){cancelAnimationFrame(this.animationId),window.removeEventListener("resize",this.onResize)}initCanvas(){let e=this.canvasRef.nativeElement;this.ctx=e.getContext("2d"),e.width=this.width,e.height=this.height}createStars(e){this.stars=Array.from({length:e}).map(()=>({x:Math.random()*this.width,y:Math.random()*this.height,size:Math.random()*2+.5,speed:Math.random()*.4+.1}))}animate=()=>{this.ctx.clearRect(0,0,this.width,this.height);for(let e of this.stars)e.y+=e.speed,e.y>this.height&&(e.y=0,e.x=Math.random()*this.width),this.ctx.beginPath(),this.ctx.arc(e.x,e.y,e.size,0,Math.PI*2),this.ctx.fillStyle=`rgba(255,255,255,${Math.random()*.5+.3})`,this.ctx.fill();this.animationId=requestAnimationFrame(this.animate)};onResize=()=>{this.width=window.innerWidth,this.height=window.innerHeight,this.initCanvas()};items=p([]);ngOnInit(){this.http.get("assets/data/conten2.json").subscribe(e=>this.items.set(e.items))}showProposal=!1;onRingTap(){this.showProposal=!0}closeProposal(){this.showProposal=!1}accept(){this.showProposal=!1,this.explodeHearts()}floatingHearts=p([]);heartId=0;explodeHearts(){let a=Array.from({length:30}).map(()=>({id:this.heartId++,x:Math.random()*100,duration:2e3+Math.random()*2e3}));this.floatingHearts.update(s=>[...s,...a]),setTimeout(()=>{this.floatingHearts.set([])},4500)}entries=[{fecha:"16 Enero 2026",titulo:"Feliz 16 de enero \u2764\uFE0F",texto:`
    ...
    `},{fecha:"",titulo:"",texto:`
      ...
      sabes que me ba\xF1e y no sale agua caliente asi que me tuve que ba\xF1ar con agua fria, un horror pero bueno esta cochino lo peor es que si abria el agua fria salia mas fria
