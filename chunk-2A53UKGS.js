import{a as D}from"./chunk-GW7PPLHE.js";import{f as O,g as P,h as k,m as S}from"./chunk-M4FQTJRQ.js";import{Da as u,Fa as j,Ka as o,La as n,Ma as h,Na as x,Oa as y,Pa as z,Qa as C,Ra as _,Sa as M,Ta as l,Ua as g,V as m,Va as w,W as c,da as p,la as q,ma as v,na as r,ra as b,va as f,ya as d}from"./chunk-7UNYG63N.js";var H=["starsCanvas"];function R(s,e){if(s&1&&(o(0,"a",17),l(1," \u{1F4F7} Ver imagen "),n()),s&2){let a=e.$implicit;u("href",a,v)}}function V(s,e){if(s&1&&(o(0,"div",15),d(1,R,2,1,"a",16),n()),s&2){let a=z().$implicit;r(),u("ngForOf",a.imagenes)}}function F(s,e){if(s&1){let a=x();o(0,"div",7),y("click",function(){let t=m(a).$implicit;return c(t.abierto=!t.abierto)}),o(1,"div",8)(2,"span",9),l(3),n(),o(4,"span",10),l(5),n(),o(6,"span",11),l(7),n()(),o(8,"div",12)(9,"p",13),y("click",function(t){return m(a),c(t.stopPropagation())}),n(),d(10,V,2,1,"div",14),n()()}if(s&2){let a=e.$implicit;r(3),g(a.fecha),r(2),g(a.titulo),r(2),w(" ",a.abierto?"\u2212":"+"," "),r(),j("abierto",a.abierto),r(),u("innerHTML",a.texto,q),r(),u("ngIf",a.imagenes==null?null:a.imagenes.length)}}var E=class s{constructor(e){this.http=e}canvasRef;ctx;stars=[];animationId;width=window.innerWidth;height=window.innerHeight;ngAfterViewInit(){this.initCanvas(),this.createStars(120),this.animate(),window.addEventListener("resize",this.onResize)}ngOnDestroy(){cancelAnimationFrame(this.animationId),window.removeEventListener("resize",this.onResize)}initCanvas(){let e=this.canvasRef.nativeElement;this.ctx=e.getContext("2d"),e.width=this.width,e.height=this.height}createStars(e){this.stars=Array.from({length:e}).map(()=>({x:Math.random()*this.width,y:Math.random()*this.height,size:Math.random()*2+.5,speed:Math.random()*.4+.1}))}animate=()=>{this.ctx.clearRect(0,0,this.width,this.height);for(let e of this.stars)e.y+=e.speed,e.y>this.height&&(e.y=0,e.x=Math.random()*this.width),this.ctx.beginPath(),this.ctx.arc(e.x,e.y,e.size,0,Math.PI*2),this.ctx.fillStyle=`rgba(255,255,255,${Math.random()*.5+.3})`,this.ctx.fill();this.animationId=requestAnimationFrame(this.animate)};onResize=()=>{this.width=window.innerWidth,this.height=window.innerHeight,this.initCanvas()};items=p([]);ngOnInit(){this.http.get("assets/data/conten2.json").subscribe(e=>this.items.set(e.items))}showProposal=!1;onRingTap(){this.showProposal=!0}closeProposal(){this.showProposal=!1}accept(){this.showProposal=!1,this.explodeHearts()}floatingHearts=p([]);heartId=0;explodeHearts(){let a=Array.from({length:30}).map(()=>({id:this.heartId++,x:Math.random()*100,duration:2e3+Math.random()*2e3}));this.floatingHearts.update(i=>[...i,...a]),setTimeout(()=>{this.floatingHearts.set([])},4500)}entries=[{fecha:"16 Enero 2026",titulo:"Feliz 16 de enero \u2764\uFE0F",texto:`
